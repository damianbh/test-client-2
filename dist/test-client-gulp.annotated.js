 ...
 */
angular.module('testClientGulp')
  .controller('ModalProviderCtrl', ["$scope", "$rootScope", "provider", "loader", "currentForm", "close", function ($scope, $rootScope, provider, loader, currentForm, close) {
    'use strict';
 ...
 */
angular.module('testClientGulp')
  .controller('ModalClientCtrl', ["$scope", "$rootScope", "client", "providers", "loader", "currentForm", "close", function ($scope, $rootScope, client, providers, loader, currentForm, close) {
    'use strict';
    var
      self = this;
